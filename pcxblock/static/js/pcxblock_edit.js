...
function PCXBlockEdit (runtime, element, data) {
    ...
    var tabList = "<li class=\"action-tabs is-active-tabs\" id=\"main-settings-tab\">Изображение</li><li class=\"action-tabs\" id=\"scenario-settings-tab\">Основные</li><li style=\"display: none;\" class=\"action-tabs\" id=\"advanced-settings-tab\">Расширенные</li>";
